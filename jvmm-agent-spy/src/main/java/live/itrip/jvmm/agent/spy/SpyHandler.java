...
public interface SpyHandler {
     ...
     */
    SpyResult handleOnBefore(int listenerId, int targetClassLoaderObjectID, Object[] argumentArray, String javaClassName, String javaMethodName, String javaMethodDesc, Object target) throws Throwable;
     ...
     */
    SpyResult handleOnThrows(int listenerId, Throwable throwable) throws Throwable;
     ...
     */
    SpyResult handleOnReturn(int listenerId, Object object) throws Throwable;
}
