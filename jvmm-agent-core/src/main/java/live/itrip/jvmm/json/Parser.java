...
import live.itrip.jvmm.json.JsonPath2.Expression;
import live.itrip.jvmm.json.nodetypes.NamedPropertyPathNode;
import live.itrip.jvmm.json.nodetypes.PathNode;
import live.itrip.jvmm.json.nodetypes.RecursiveDescentPathNode;
...
public class Parser {
	...
	public Expression parseExpression(String str) throws JsonPathException {
