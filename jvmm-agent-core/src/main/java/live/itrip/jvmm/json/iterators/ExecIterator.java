 ...
 *
 */
public class ExecIterator extends live.itrip.jvmm.json.iterators.PeekableIterator<JsonElement> {

	private final JsonPath2.Expression expression;
	private final live.itrip.jvmm.json.iterators.PeekableIterator<JsonElement> in;
	private final int filterPosition;
	private live.itrip.jvmm.json.iterators.PeekableIterator<JsonElement> current;
	private JsonElement next = null;
	private boolean isNextTaken = false;

	public ExecIterator(JsonPath2.Expression expression, live.itrip.jvmm.json.iterators.PeekableIterator<JsonElement> in, int filterPosition) {
