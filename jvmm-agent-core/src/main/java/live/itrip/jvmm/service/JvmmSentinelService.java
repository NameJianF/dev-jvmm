...
import live.itrip.jvmm.util.HttpUtils;
...
import live.itrip.jvmm.monitor.server.entity.conf.SentinelConf;
import live.itrip.jvmm.monitor.server.entity.conf.SentinelSubscriberConf;
...
public class JvmmSentinelService implements JvmmService {
    ...
    protected void publish(SentinelSubscriberConf subscriber, String body, int interval) {
        ...
        try {
            ...
            HttpUtils.doPost(url, body, headers);
            failCounter.set(0);
        } catch (IOException e) {
