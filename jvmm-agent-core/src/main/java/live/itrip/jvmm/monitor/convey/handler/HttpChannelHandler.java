...
import live.itrip.jvmm.monitor.convey.annotation.HttpController;
import live.itrip.jvmm.monitor.convey.annotation.HttpRequest;
import live.itrip.jvmm.monitor.convey.annotation.RequestBody;
import live.itrip.jvmm.monitor.convey.annotation.RequestParam;
...
import live.itrip.jvmm.util.meta.MultiMap;
...
public abstract class HttpChannelHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    static {
        controllers = ReflexUtil.scanAnnotation(SystemPropertyUtil.get("jvmm.scanPack", "org.fengjianfeng.jvmm"), HttpController.class);
