...
import live.itrip.jvmm.monitor.convey.annotation.JvmmController;
import live.itrip.jvmm.monitor.convey.annotation.JvmmMapping;
import live.itrip.jvmm.monitor.convey.auth.JvmmBubble;
import live.itrip.jvmm.monitor.convey.auth.JvmmBubbleDecrypt;
import live.itrip.jvmm.monitor.convey.auth.JvmmBubbleEncrypt;
import live.itrip.jvmm.monitor.convey.entity.JvmmRequest;
import live.itrip.jvmm.monitor.convey.entity.JvmmResponse;
import live.itrip.jvmm.monitor.convey.entity.ResponseFuture;
...
import live.itrip.jvmm.common.exception.InvalidJvmmMappingException;
import live.itrip.jvmm.common.exception.InvalidMsgException;
import live.itrip.jvmm.util.ReflexUtil;
import live.itrip.jvmm.util.SystemPropertyUtil;
import live.itrip.jvmm.monitor.convey.channel.ChannelInitializers;
import live.itrip.jvmm.monitor.convey.channel.JvmmServerChannelInitializer;
import live.itrip.jvmm.monitor.convey.socket.JvmmConnector;
...
public abstract class JvmmChannelHandler extends SimpleChannelInboundHandler<String> {
    ...
    static {
        controllers = ReflexUtil.scanAnnotation(SystemPropertyUtil.get("jvmm.scanPack", "org.fengjianfeng.jvmm"), JvmmController.class);
